...
final class OpenWeatherJsonParser {
    ...
    private static final String OWM_WEATHER_ICON= "weatherIconId";
    ...
    private static WeatherEntry fromJson(final JSONObject dayForecast,
        ...
        int weatherIcon = weatherObject.getInt(OWM_WEATHER_ICON);
        ...
        return new WeatherEntry(weatherId, weatherIcon , new Date(dateTimeMillis), max, min,
